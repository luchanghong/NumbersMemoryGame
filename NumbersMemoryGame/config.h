...
// 功能区域
#define NMG_CFG_RIGHT_AREA_PADDING 20
typedef int NMG_CFG_BUTTON_TYPE;
#define NMG_CFG_BUTTON_PRIMARY  0
#define NMG_CFG_BUTTON_SUCESS   1
#define NMG_CFG_BUTTON_INFO     2
#define NMG_CFG_BUTTON_WARNING  3
#define NMG_CFG_BUTTON_DANGER   4
